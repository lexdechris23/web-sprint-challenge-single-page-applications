...
const formSchema = yup.object().shape({
    name: yup.string().required('Please enter a name').min(2, 'Name must be at least 2 characters long'),
...
<div className="add-to">
    ...
    <button id="submit-btn" onClick={(evt)=> evt.preventDefault}>Place Order</button>
</div>
<div className='checkout'>
     <PizzaCheckout confirm={newOrder} />
     </div>
</div>
</form>
)}
